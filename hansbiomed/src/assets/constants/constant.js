import {
  ...
  incosmeticsFrance,
  medicaGermany,
} from "../images/PREvents/import";
import {
  artificialBreastForm,
  botulinumToxinTypeA,
  lypolysis,
  hyaluronicAcidFiller,
  pdoCog,
  pdoMonoScrew,
  skinBooster,
} from "../images/Biologics/import";
import {
  chinImplant,
  cheekImplant,
  noseImplant,
  siliconeBreastImplant,
  tissueExpander,
} from "../images/MedicalDevices/import";
import {
  activo,
  aromaGrand,
  aromaGrandCheveux,
  ...
  pentagonGrand,
  tinea,
} from "../images/Equipments/import";
import {
  BiologicsBanner,
  MedicalDevicesBanner,
  PRBanner,
  EquipmentsBanner,
} from "../images/PageBanners/import";
    ...
    [
      {
        ...
        details: {
          "About PDO Cod Threads":
            "Enhance your skin's elasticity and firmness with PDO Cod Threads, designed for non-surgical facial lifting and contouring. These biocompatible threads stimulate collagen production, delivering natural and youthful results over time. Ideal for rejuvenating sagging skin with minimal downtime.",
          Types: [
            "19G-100mm, bidirectional cod, W-type",
            "18G-100mm, bidirectional cod, W-type",
            "21G-90mm, bidirectional cod, L-type for eyebrow lifting",
            "Double Arms, Two needles 400mm, for face lifting",
          ],
        },
        img: pdoCog,
        category: "Skin",
      },
      {
        ...
        details: {
          "About Hyaluronic Acid Filler":
            "Achieve a refreshed and youthful appearance with Hyaluronic Acid Fillers. These dermal fillers hydrate, smooth wrinkles, and restore natural volume to lips, cheeks, and jawlines, offering subtle and long-lasting enhancements with minimal downtime.",
          Types: ["Biphasic HA Dermal Fillers", "Monophasic HA Dermal Fillers"],
          "Biphasic HA Features": [
            "Adding of non cross linked HA disappear in 1-2wks",
            "Big particle size",
            "Relatively short duration",
            "Low cross linking ratio",
            "Easy to mold shape",
          ],
          "Monophasic HA Features": [
            "Non adding of non cross linked HA",
            "Longer duration",
            "Relatively high duration",
            "Difficult to mold shape",
            "Relatively high cross linking ratio",
          ],
          "Recommended Applications": [
            "A type : Cheek, Chin, Forehead, Nose",
            "B-type : Nasolabial folds, Lips",
            "C-type : Fine wrinkle, Around eyes",
          ],
          "Recommended Dose": [
            "Nose : 1-2ml",
            "Nasolabial folds : 2-3ml",
            "Forehead : 3-5ml",
            "Lip each side : 1 ml",
            "Cheek : 4-10ml",
            "Short chin : 2-4ml",
            "Sunken Eye : 1ml",
            "Temporal Area Depression Each : Over 2ml",
          ],
        },
      ...
      },
      {
        ...
        details: {
          "About Skin Booster":
            "Revitalize your skin with Skin Boosters, designed to deeply hydrate and improve texture from within. These treatments enhance elasticity, smooth fine lines, and restore a radiant, healthy glow for a refreshed appearance.",
          Description:
            "The most of hyaluronic acid gel products for mesotherapy are non cross linked HA but skin booster( biorevitalization) is cross linked HA gel same as dermal fillers, so has much better duration and safety. Non cross linked HA gel can not be autoclave sterilized, also skin booster( biorevitalization) has lidocaine to lower pain",
          Merits: [
          ...
          Precaution:
            "This booster( biorevitalization) contain cross linked hyaluronic acid (HA). Once injected to epidermis, this can cause nodule and papule, so injection layer will be dermis layer ,and use mesotherapy gun needle with depth more than 1.5mm. Do not inject at one point too much. Inject widely deeply and evenly. After injection compress treated area with dry gauze.",
          Protocols: [
            "2-3 session is needed",
            "Interval one month",
            "After second session, the effect can be seen",
            "This booster is usually used with meso gun. If you do not have meso gun, you can use the meso needle",
          ],
        },
        img: skinBooster,
        category: "Bone",
      },
      {
        ...
        details: {
          "About Lipolysis":
            "Target stubborn fat deposits with Lipolysis, a non-surgical solution to contour and reshape your body. This treatment breaks down fat cells, helping you achieve a more sculpted and defined look with minimal downtime.",
          Description:
            "Lipolysis solution for double chin and body. Do not use it for face",
          Ingredients: [
            "Deoxycholic acid 10mg/cc",
            "Q.S- Phosphate buffer solution",
          ],
      ...
      },
      {
        ...
        details: {
          "About Botulinum Toxin Type A":
            "Smooth wrinkles and fine lines with Botulinum Toxin Type A, the trusted solution for relaxing facial muscles. Achieve a rejuvenated and youthful appearance with quick, non-invasive treatment.",
          "Active Ingredient":
            "Clostridium botulinum toxin type A (Hall strain).",
          Description:
            "A lyophilized white powder for injection in a colorless transparent vial.",
          "Storage Condition":
            "Store at -15 ~ -5℃ or at 2 ~ 8℃ in a refrigerator, in hermetic container.",
          "Package Unit": "1 vial",
          ...
          "Indication and Usage": [
            ...
            "To temporarily improve moderate to severe glabellar lines related to eyebrow wrinkle muscle (corrugator muscle) and/or procerus muscle activity in adults aged from 20 to 65",
      ...
      },
      {
        ...
        details: {
          "About PDO Mono and Screw Threads":
            "Rejuvenate your skin with PDO Mono and Screw Threads, perfect for improving skin texture, tightening, and lifting. These threads stimulate collagen production for natural, long-lasting results.",
          Benefit: [
            "No need for cuts on the skin",
            "Does not require serious anesthesia",
            "Quick rehabilitation",
            "The procedure takes no more than 30-40 minutes",
    ...
    [
      {
        ...
        details: {
          "About Silicone Breast Implant":
            "Silicone Breast Implants offer a natural feel and long-lasting results, ideal for individuals seeking breast augmentation or reconstruction. With multiple models available, it ensures both aesthetic enhancement and safety.",
          Features: [
            "Multiple Models to Choose From",
            "High wear resistance, can withstand 6.5 million times of fatigue resistance test",
            "Safe and reliable materials",
            "The gel has strong cohesion, the shell breaking elongation can exceed 1000%, and the resilience is excellent",
          ],
        },
      ...
      },
      {
        ...
        details: {
          "About Tissue Expander":
            "Tissue Expanders are ideal for patients undergoing reconstructive surgeries, designed to gradually stretch skin for future implant procedures. Available in various models for customized treatment.",
          Features: [
            "Various models and specifications",
            "U-shaped limit groove, puncture-proof",
            "Safe and reliable materials",
            "Internal and external catheter, adjustable length",
          ],
        },
        img: tissueExpander,
      ...
      },
      {
        ...
        details: {
          "About Chin Implant":
            "Chin Implants are used to enhance facial harmony by improving chin projection, offering a natural look and feel for individuals seeking cosmetic enhancement.",
          Features: [
            "Various specifications and sizes",
            "Safe and reliable materials",
            "Complete range of styles, can be matched with different procedures",
          ],
        },
        img: chinImplant,
      ...
      },
      {
        ...
        details: {
          "About Nose Implant":
            "Nose Implants are designed to enhance nasal shape, improve symmetry, and provide long-lasting results with minimal risk of allergic reactions.",
          Features: [
            "Low risk of rejection or allergic reactions",
            "Used to enhance nasal projection, height, or symmetry",
            "Can significantly improve nasal contours and overall facial harmony",
          ],
      ...
      },
      {
        ...
        details: {
          "About Cheek Implant":
            "Cheek Implants are used to improve facial volume and contour, offering a balanced and youthful appearance. Ideal for those seeking facial enhancement through a minimally invasive procedure.",
          Features: [
            "Low risk of rejection or allergic reactions",
            "Used to enhance cheek volume and improve symmetry",
            "Can significantly improve overall facial balance",
          ],
          Types: ["L-Type", "L30", "T-Type", "Type 1", "Type C", "P-Type"],
        },
        img: cheekImplant,
    ...
    [
      {
        ...
        details: {
          ...
          "Laser Source": "Nd:YAG",
          Indications:
            "Tatto removal (1,064/532nm), Nevus of Ota (1,064nm), Epidermal Lesions (532nm)",
          "Various Hand Piece": [
            "Zoom Hand Piece",
            "MLA Hand Piece",
            "Collimated Hand Piece",
          ],
          Advantages: [
            "High Peak Power",
            "Less Side Effect",
            "Less Pain",
            "Types of Three Pulses",
          ],
          "Product Specifications": [
            "Wavelength	: 1,064 [nm] / 532 [nm]",
            "Operation Method	: Q-switched Nd:YAG",
            "Pulse Energy 1064 mode(Q-switched Mode) : Max. 2,700 [mJ]",
            "Pulse Energy 532 mode(Q-switched Mode) : Max. 900 [mJ]",
            `Type of Pulse:	Single Pulses(One whole pulse), Double Pulses (Photoacoustic twin pulses), Triple Pulses (Photoacoustic triple pulses)`,
            "Pulse Width :	5 ~ 10 [ns] (Q-switched Mode) / 500 [㎲] (FR mode)",
            "Spot Size :	2 ~ 10 [㎜]",
            "Pulse Rate : 1,064, 32, FR Mode	1 ~ 10 [Hz]",
            "Memory	: 5 User Programmable Memory",
            "Optical Delivery :	Articulated Arm",
            "Aiming Beam :	Diode 650 [nm] (Adjustable Brightness)",
            `Display : 10.4" LCD`,
            "Cooling	: Closed Circuit Water to Air",
            "Input Power : 110/220 [VAC], 50/60 [Hz]",
            "Dimension : 315 x 825 x 1,022 [mm] (W x D x H)",
            "Weight : 90 [kg]",
          ],
          "What is Q-Switched Nd:YAG Laser ?":
            "The Q-Switched Nd:YAG Laser method with short pulse width and low energy used for removal of pigment demonstrated better treatment effects than other conventional treatment methods. This treatment method is a new concept that can be described as selective photo rejuvenation with minimal thermal damage and inflammation reaction to affected tissues by pigmentation.",
        },
        img: activo,
        category: "Skin",
      },
      {
        ...
        details: {
          "About Aroma Grand": [
            "AROMA GRAND delivers thermal energy to hair follicle and it is selectively absorbed to the melanin in the hair follicle. Thus, the destruction of melanin will be resulted.",
          ...
          Strengths: [
            "Simple, Easy to operation using by GUI",
            "Speedy treatment time",
            "Excellent clinical results",
            "Decent output power of diode (600W)",
            "The relatively lighter hand-piece with 600W output power",
          ...
          "Product Specifications": [
            "Light Source	: Diode laser module",
            "Output Energy	: 600 [W] / (6 bars)",
            "Warranty : 10,000,000 Shots or Within 1 year(Whichever comes earlier, would be expired)",
            "Wavelength	: 808 [nm]",
            "Fluence	: 100 [J/cm²]",
            "Pulse Duration	: 10 ~ 350 [ms]",
            "Spot Size (Sapphire Size) : 14 x 15 [mm] / 600W",
            "Repetition Rate : 1 ~ 10 [Hz]",
            "Input Voltage	: 200-240 [VAC], 50/60 [Hz]",
            "Dimension : 480 x 640 x 1,230 [mm] (W x D x H)",
            "Weight :	67 [kg]",
          ],
        },
        img: aromaGrand,
      ...
      },
      {
        ...
        details: {
          ...
          "Product Specifications": [
            "Light Source	: Diode laser module",
            "Output Energy	: 600 [W] / (6 bars) , 800 [W] / (8 bars)",
            "Warranty : 10,000,000 Shots or Within 1 year(Whichever comes earlier, would be expired)",
            "Wavelength	: 808 [nm]",
            "Fluence	: 100 [J/cm²] (600[W]), 107.6 [J/cm²] (800[W])",
            "Pulse Duration	: 10 ~ 350 [ms]",
            "Spot Size (Sapphire Size) : 14 x 15 [mm] / 600W , 14 x 18.5 [mm] / 800[W]",
            "Repetition Rate : 1 ~ 10 [Hz]",
            "Input Voltage	: 110/220 [VAC], 50/60 [Hz]",
            "Dimension : 420 X 510 X 1,040 [mm] (W x D x H)",
            "Weight :	50 [kg]",
          ],
        },
      ...
      },
      {
        ...
        details: {
          ...
          Strengths: [
            "TFDA & SFDA & KFDA approval as Lifting for Eyebrow, CE Certificated",
            "Five types of cartridge 1.5mm, 3.0mm, 4.5mm, 8.0mm (Optional) and 13.0mm (Optional)",
            "The shortest treatment time by continuous mode",
            "Reasonable price of consumables",
            ...
            "Less pain than other HIFU device",
            "Now, HIFU system is developed to area of Body for slimming.",
            "HIPRO / HIPRO-S can make thermal coagulation to layer of fat and help to reduce fat by using principle of HIFU.",
            "Make over 55℃ of TCP zone on SMAS layer by delivering HIFU energy.",
            "By wound healing process on TCP zone of SMAS, the surface of muscle contraction, regrowth of collagen and elastin are stimulated by 1.5mm & 3.0mm cartridge.",
            "Skin lifting and tightening occurs by collagen regeneration process of dermis and the contraction of SMAS layer.",
          ],
          "Product Specifications": [
            "Energy Type : HIFU Energy",
            "Energy Output : 0.1 ~ 2.0 [J]",
            "Input Voltage : 100-240 [VAC], 50/60 [Hz]",
            "Interval : 1.0 ~ 2.0 [mm]",
            "Length : 15mm (Half length), 30mm (Full length)",
            "Cartridge A (1.5mm) : 10,000 Shots",
            "Cartridge B (3.0mm) : 10,000 Shots",
            "Cartridge C (4.5mm) : 10,000 Shots",
            "Cartridge D (8.0mm, Optional) : 10,000 Shots",
            "Cartridge E (13.0mm, Optional)	: 10,000 Shots",
            "Dimension :	HIPRO - 430 x 570 x 1,050 [mm], HIPRO-S - 340 x 380 x 270 [mm] (W x D x H)",
            "Weight : HIPRO : 40 [kg], HIPRO-S : 7 [kg]",
          ],
        },
        img: hipro,
        category: "Skin",
      },
      {
        ...
        details: {
          ...
          "Product Specifications": [
            ...
            "Energy Output : 0.1 ~ 2.0 [J]",
            "Input Voltage : 100-240 [VAC], 50/60 [Hz]",
            "Dimension : 340 x 380 x 300 [mm] (W x D x H)",
            "Weight : 10 [kg]",
            "Frequency : 3.0 [MHz]",
            "Depth(FACE) : 1.5 ~ 4.5 [mm]",
      ...
      },
      {
        ...
        details: {
          "About Hipro Q":
            "HIFU energy penetrates and makes thermal coagulation to deep dermis and subcutaneous fibrous tissue. Natural wound healing process creates new elastic collagen, hence resulting in lifting and tightening loose skin for rejuvenation over time. The HIFU energy can stimulate the collagen to be remodeled for skin tightening. The strong point of HIPRO-Q is that products' weight is only 3.5kg",
          "Treatments of HIPRO-Q for Lifting & Tightening": [
            "Forehead wrinkle",
            "Nasolabial fold",
          ...
          "Product Specifications": [
            "Energy Type : HIFU Energy (High Intensity Focused Ultrasonic)",
            "Energy Output : Max 1.5 [J]",
            "Repetition Rates : 7 [Hz]",
            "Depth for Face : 3.0 [mm]",
            "Hand Piece time : 2,000 [min]",
            "Input Voltage : 100-230 [VAC], 50/60 [Hz]",
            "Dimension : 260 x 310 x 175 [mm] (W x D x H)",
            "Weight : 3.5 [kg]",
          ],
        },
        img: hiproQ,
      ...
      },
      {
        ...
        details: {
          "About Hipro L":
            "HIPRO-L is double-frequency ultrasound waves which mixes different frequencies up to 10 [MHz] to be sequently emitted with 1 [MHz] and 3 [MHz] waves as well as 3 [MHz] and 10 [MHz] waves. These sequent frequencies generate the body and face tissue stimulation cavitation and increased blood flow to fulfill the modern aesthetical applications for skin rejuvenation.",
          "Product Specifications": [
            "Energy Type : Ultrasound Wave Energy",
            "Power : Max 2 [W/cm²]",
            "Frequency : Face - 3 / 10 [MHz], Body - 1 / 3 [MHz]",
            "Input Voltage : 100-240 [VAC], 50/60 [Hz]",
            "Dimension : 350 x 412 x 255 [mm] (W x D x H)",
            "Weight : 5 [kg]",
          ],
        },
        img: hiproL,
      ...
      },
      {
        ...
        details: {
          ...
          "Product Specifications": [
            "Power : Max. 20/30 [W] (by RF tube)",
            "Fractional Laser : Pulse Energy - 3 ~ 300 [mJ], Scan Area Size - 3 x 3 ~ 20 x 20 [mm], Scan Area Shape - Square & Rectangular",
            "Continues Wave :	Spot Size(30W) - 50mm Hand Piece (1.0 [mm]) & 100mm Hand Piece (1.5 [mm]), Power - Max. 20/30 [W] (by RF tube)",
            "Ultra Pulse : Frequency - 10 ~ 1,000 [Hz], Duration - 100 ~ 2,000 [us]",
            `Display : 8" LCD`,
            "Aiming Beam : Diode Laser Beam 650nm (Light Adjustable)",
            "Laser Delivery : 7Joint Articulated Arm",
            "Input Voltage : 200 ~ 240 [VAC], 50/60 [Hz]",
            "Weight : 62 [kg]",
            "Dimension : 450 x 510 x 1,150 [mm] (W x D x H)",
          ],
        },
        img: pentagonGrand,
        category: "Skin",
      },
      {
        ...
        details: {
          ...
          "Product Specifications": [
            "Laser Type :	CO2 Fractional + Surgical Laser System",
            ...
            "Weight : 52 [kg]",
            "Dimension : 460 x 520 x 1,320 [mm] (W x D x H)",
          ],
          Advantages: [
            "High Peak Power",
            "Fine Beam Quality",
            "Powerful and Rapid Treatment",
            "Less Pain",
            "Fractional Laser, Continues Wave, Ultra Pulse Mode",
            "Two Type Shapes in Fractional Laser",
          ],
        },
        img: pentagonGlassF,
        category: "Skin",
      },
      {
        ...
        details: {
          "About Pentagon G Slim":
            "PENTAGON G SLIM, the CO2 Surgical Laser (Glass Tube) Unit, makes the beam divide into micro-sized units and leaves normal tissues among the beams to reduce direct skin damages to shorten the down time and to allow the skin to be cured faster.",
          Indications: [
            "Hemorrhoid",
            "Condyloma",
            "Spots",
          ...
          "Product Specifications": [
            "Laser Type : CO2 Surgical Laser Unit",
            "Laser Source : CO2 Glass Tube",
            "Wavelength : 10,600 [㎛]",
            "Power : Max. 30W",
            ...
            "Weight : 46 [kg]",
            "Dimension : 320 x 420 x 1,140 [mm] (W x D x H)",
          ],
          Advantages: [
            "High Peak Power",
            "Fine Beam Quality",
            "Less Pain",
            "Continues Wave, Ultra Pulse Mode",
          ],
        },
        img: pentagonGSlim,
        category: "Skin",
      },
      {
        ...
        details: {
          "About Tinea": [
            ...
            "Non-thermal Laser Treatment",
            "Low Level Laser Therapy Method",
            "No Pain, No Harm",
          ],
          "Product Specifications": [
            "Laser Source	: Diode Laser",
            "Wavelength	: 405 [nm] / 635 [nm]",
            "Operation Time(C/W Mode)	: Mode 1 - Max. 12 [Min], Mode 2 - Max. 15 [Min], Mode 3 - Max. 20 [Min]",
            "Emitting Area	140 x 1.2 [mm]",
            "Max. Output	: 405 [nm] - 20mW, 635 [nm] - 50mW",
            `Display	: [Product] 7" LCD (Touchscreen), [Lift] 15" LCD`,
            "Input Voltage : 100-240 [VAC], 50/60 [Hz]",
            "Dimension	: [Product] 406 x 382 x 340 [mm] (W x D x H), [Lift] 600 x 680 x 1,300 [mm] (W x D x H)",
          ...
          "What is LLT": [
            ...
            "405 [nm] Wavelength : Removal the onychomycrosis by killing fungus",
            "635 [nm] Wavelength : Activating the blood circulation cell regeneration and immunity for delaminating germ",
          ],
        },
        img: tinea,
        category: "Skin",
      },
      {
        ...
        details: {
          "About Noable Laser": [
            "The NOABLE LASER is a laser system designed to target the acne at the root of the related problems.",
            "It can be effectively used to treat acne and oily skin, improve the skin of acne scarring, and rejuvenate the complexion by increasing collagen production.",
          ],
          "How does it Work": [
          ...
          "Product Specifications": [
            "Laser Type	: Laser System, Diode Laser Module",
            "Laser Source :	Diode Laser Module manufactured by Lumics Gmbh",
            "Indications :	Acne Treatment (STAMPING MODE), Skin Renewal (TONING MODE)",
            "Adjustable Spot Size	: 4mm / 6mm / 8mm / 10mm",
            "Wavelength :	1,450 [nm]",
            "Mode	: STAMPING / TONING",
            "Spot Size	: 4mm / 6mm / 8mm / 10mm",
            "Memory	: Available 3 Memory Space",
            "Max. Output	: 22W",
            "Input Voltage : 100-240 [VAC], 50/60 [Hz]",
            "Dimension	: 420 x 420 x 1,560 [mm] (W x D x H)",
            "Weight :	36 [kg]",
          ],
          "What is DCD":
            "DCD(Direct Cooling Device) is a skin cooling device that protects the skin surface from the heat that may occur due to laser energy during the treatment.",
          Advantages: [
            "Luxurious Design",
            "Spot Size Change without Changing Lens",
            "DCD Cooling Method",
            "Can be Operated by Hand piece GUI",
          ],
        },
        img: noableLaser,
        category: "Skin",
